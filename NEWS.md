...
* The table of contents opens already filled: the post-processor writes the headings into Word's own TOC field, linked to their bookmarks. Word fills the page numbers at its first update-fields prompt, and saving then clears the prompt.
